...
function fillBizHint(c){const g=guessBiz(c),h=$('#detailBizHint'),b=$('#detailBizGuess');if(!h)return;
...
const bz=$('#detailBiz');if(bz){bz.value=c.bizType||'';bz.onchange=()=>{c.bizType=bz.value||'';save();fillBizHint(c)};fillBizHint(c)}
